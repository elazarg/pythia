...
Field = typing.TypeVar('Field', str, int, tac.Var)


@dataclass(frozen=True)
class MapType(typing.Generic[Field]):
    items: frozendict[T, TypeExpr]

    def __repr__(self) -> str:
        return f'{{{", ".join(f"{k}: {v}" for k, v in self.items.items())}}}'


Tuple: typing.TypeAlias = MapType[int]
Struct: typing.TypeAlias = MapType[tac.Var]
Dict: typing.TypeAlias = MapType[str]
